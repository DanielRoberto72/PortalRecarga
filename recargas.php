    ...
    <div class="columns">
      <div class="column">
        ...
        <div class="control has-icons-left">
          <input maxlength="" placeholder="" type="text" class="input" name="MSISDN" id="MSISDN">
...
<div class="top-sales box" >
    <div class="title">Informações da recarga</div>
      <ul class="top-sales-details">
          <hr>
          <li>
              <span class="product"><?php echo'MSISDN: '.$msisdn?></span>
          </li>
          <li>
              <span class="product"><?php echo'MVNO: NOME DA OPERADORA'?></span>
          </li>
          <li>
              <span class="product"><?php echo'O plano que será recarregado é: Plano 34,90'?></span>
          </li>
          <li>
              <span class="product"><?php echo'A validade do plano é de: 32 dias'?></span>
          </li>
          <li>
              <span class="product"><?php echo'Os benefícios do plano acumulam'?></span>
          </li>
          </ul>
          <div class="column">
          
              <label for="Recarga" class="label"></label><br>
                <input id="div1" type="submit" class="button" value="Deseja confirmar a recarga?"/>
          </div>
    </div>
      <div class="input-box">
